...
const ProductDetails = ({ data }) => {
  ...
  const handleMessageSubmit = () => {
    navigate("/inbox?conversation=50fjkewdfkedwdjsv46");
  };
  return (
              ...
              <div className="w-full 800px:w-[50%] pt-3">
                ...
                <div className="flex items-center pt-8">
                  ...
                  <div
                    ...
                    <span className="text-[#fff] flex items-baseline">
...
const ProductDetailsInfo = ({ data }) => {
  ...
  return (
    <div className="bg-[#f5f6f6] px-3 800px:px-10 py-2 rounded h-[40vh]">
        ...
        <div className="w-full block 800px:flex p-5">
          <div className="w-full 800px:w-[50%]">
            ...
            <p className="pt-2">
              ...
              amet ipsum distinctio voluptas earum, omnis dolorem quam incidunt
              repudiandae, eligendi officia sint ut dolore unde voluptate
              cupiditate. Nesciunt, deserunt.
            </p>
          </div>
          <div className="w-full 800px:w-[50%] mt-5 800px:flex flex-col items-end">
            <div className="text-left">
              ...
              <h4 className="font-[600] pt-3">
                Total Products :<span className="font-[500]">1,223</span>
              </h4>
              <h4 className="font-[600] pt-3">
                Total Reviews :<span className="font-[500]">334</span>
              </h4>
              <Link to="/">
                <div
